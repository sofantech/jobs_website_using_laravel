            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <input class="w-100 form-control" name="job_name" type="text" placeholder="المسمى الوظيفي">
                </div>
                <div class="modal-body">
                  <textarea class="w-100 form-control" name="job_details" type="text" placeholder="تفاصيل الوظيفة"></textarea>
                </div>
                <!-- <div class="modal-body">
                  <input class="w-100 form-control" type="text" placeholder="موقع الوظيفة">
                </div> -->
                <div class="modal-body">
                  <select class="form-select" name="job_type">
                    <option>دوام كامل</option>
                    <option>دوام جزئي</option>
                    <option>عمل مؤقت</option>
                    <option>تدريب</option>
                  </select>
                </div>
                <div class="modal-body">
                  <select class="form-select" name="job_scope">
                    <option>هندسة</option>
                    <option> مالية</option>
                ...
                <div class="modal-body">
                  <input class="w-100 form-control" name="experince" type="text" placeholder="الخبرة .... سنة ">
                </div>
                <div class="modal-body">
                  <input class="w-100 form-control" name="salary" type="text" placeholder="الراتب">
                </div>
                <div class="modal-body">
                  <label>تاريخ انتهاء التقديم</label>
                  <input class="w-100 form-control" type="date">
                </div>
